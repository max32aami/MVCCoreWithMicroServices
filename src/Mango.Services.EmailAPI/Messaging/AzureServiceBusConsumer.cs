...
{
    public class AzureServiceBusConsumer : IAzureServiceBusConsumer ///this class is to read messagess from Azure Bus Max
    {
        ...
        public AzureServiceBusConsumer(IConfiguration configuration, EmailService emailService)
        {
            ...
            _emailCartProcessor = client.CreateProcessor(emailCartQueue); // to listen new messages sent to the queue
